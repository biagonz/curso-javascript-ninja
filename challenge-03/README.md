...
*/
pessoa.nomeCompleto() //"Olá! Meu nome é Pessoa Objeto!"
...
pessoa.apresentacao = function () {
    ...
    + ', tenho '+ pessoa.idade + ' ano' + plural(pessoa.idade) + ', ' 
    + pessoa.altura 
    + ', meu peso é '+ pessoa.peso 
    + ' e, só hoje, eu já caminhei '+ pessoa.caminhouQuantosMetros+' metro' + plural(pessoa.caminhouQuantosMetros)+'!';
}
